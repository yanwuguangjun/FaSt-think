...
//    常用功能 可进行定制
    protected $scene = [
        'user_add_adopt'=>['sex','age','species','note','category','province','city','area','agree','tel','email','open','captcha','title'],
        /*普通用户发布领养*/
