...
class Article extends Validate
{
    ...
    protected $rule = [
        ...
        'catename' => 'require|max:25|chs',
        'keywords' => 'require|max:5|chs',
        'description' => 'chsDash|require|max:25',
        'link' => 'require',
        'id'=>'require|number',
        'pic'=>'image',
        'state'=>'accepted',
        'title'=>'max:25|require',
        'author'=>'require|max:25',
        'cateid'=>'number|require',
        'content'=>'require',
    ];
...
//    不常用功能 可进行定制
    protected $scene = [
        'add_artmod' => ['catename', 'keywords','description'],  //对username，password 不验证；
        'artmod_update' => ['catename', 'keywords','description','id'],  //只对这几项验证
        'add' => ['cateid','state','author','title','content','keywords','description','pic'], //对username，password 不验证；
    ];
